...
public class OrderExcelExport extends AbstractXlsxView {
    ...
    protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (note != null) {
            currentRow1.createCell(1).setCellValue("Ghi Chú: " + DataUtil.safeToString(note.getNote(), ""));
        }
        ...
        if (status != null) {
            ...
            if (orderStatusObject != null) {
                currentRow3.createCell(0).setCellValue("Trạng thái: " + orderStatusObject.getName());
            }
